...
module.exports = class MarkdownFile {
  ...
  toJSON () {
    return Object.assign({}, { url: this.url, title: this.attributes.title, date: this.attributes.date, html: this.html, md: this.md }, { data: this.attributes })
  }
...
async function renderMdWithLayout ({ md, attributes, layout, nunjucksFilters, includesDir = '_includes', url, collections = {} }) {
